...
class ChannelMessagesRepository {
    async create({member_channel_id, user_id, channel_id, content}){
        console.log('create channel message params:', { member_channel_id, user_id, channel_id, content });
        const channel_message = new ChannelMessage({ member_channel_id ,  user_id,channel_id, content})
